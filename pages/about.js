    ...
    return(
        <PageLayout title="Learn More About John">
            <div className="h-screen flex flex-col justify-center items-center px-12 space-y-4">
                ...
                <p className="text-l md:text-3xl md:w-1/2 text-center">I’m John Ezell, a software engineer who focuses on making the most
                ...
                <p className="text-sm md:text-xl md:w-1/2 text-center text-gray-500">Since I was born, I have always excelled at technology.
